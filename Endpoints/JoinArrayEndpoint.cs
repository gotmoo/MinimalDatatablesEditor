...
public class JoinArrayEndpoint : IEndpoints
{
    public static void DefineEndpoint(IEndpointRouteBuilder app)
    {
        ...
        /// loaded.
        /// </summary>
        app.MapMethods("/api/joinArray", new[] {"POST", "GET"},
            (HttpRequest request) =>
            {
                ...
                var response = new Editor(db, "users", "users.id")
                    ...
                    .MJoin(new MJoin("permission")
                        ...
                        .Validator("permission[].id",
                            Validation.MjoinMaxCount(4, "No more than four selections please"))
                        .Field(new Field("id")
                            .Options(new Options()
                                .Table("permission")
                                .Value("id")
